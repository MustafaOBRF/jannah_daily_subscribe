...
### Actividad: la tarjeta de la carrera del bien
...
### Un du'a auténtico que aprendemos antes de dormir
...
### Historia del hadiz: Umair ibn al-Humam el día de Badr
...
- **`بَخٍ بَخٍ` (bakh bakh)** — una expresión que se dice con admiración y asombro ante algo grandioso y alegre.
- **`التشمير` (at-tashmir)** — elevar la determinación y esforzarse con seriedad en la obra, como quien se recoge el borde de su túnica para apresurarse.
...
### Actividad: la tarjeta «mi carrera hacia el bien»
...
### Un du'a auténtico antes de dormir
...
### Un episodio profético: la decisión de Umair ibn al-Humam en su momento decisivo
...
5. ¿Hay diferencia entre apresurarse en el arrepentimiento y apresurarse en otras decisiones trascendentales? Debátanlo.

<!-- unit:end -->

<!-- unit:start id="13+.activity" kind="activity" -->

### Actividad: el protocolo «arrojar los dátiles»
...
**Preparación:** el profesor repasa el contexto del hadiz de Umair en la batalla de Badr y su grado de autenticidad, prepara una formulación clara que distinga entre el apresuramiento legítimo en su contexto y el impulso sin límite, y prepara ejemplos contemporáneos de obras postergadas no relacionadas con el combate.
...
**Actividad — 15 minutos:** los estudiantes realizan la tarjeta de "la carrera del bien" de forma individual, luego cada pareja revisa la tarjeta del otro para verificar que exista una fecha definida y un primer paso concreto, sin obligar a revelar detalles personales sensibles.

<!-- lesson-plan:assessment -->
**Evaluación y cierre — 10 minutos:** tarjeta de salida: «menciona la diferencia entre el apresuramiento y la temeridad en tres líneas, y luego indica tu fecha para realizar tu obra postergada». El profesor cierra leyendo la aya de Al-Hadid.
...
<!-- lesson-plan:assessment -->
**Evaluación y cierre — 6 minutos:** pregunta: «¿Qué bien hiciste ahora?». Elogia cada respuesta, y luego lee el du'a despacio para que los niños repitan lo que puedan.

<!-- lesson-plan:differentiation -->
**Atención a las diferencias:** se permite responder con gestos o dibujos, y al niño más avanzado se le encarga proponer una buena obra adicional para su hermano o amigo.

<!-- lesson-plan:safeguards -->
**Precauciones docentes:** no se presentan detalles del combate ni de la muerte de forma aterradora, ni se dice que postergar sea un pecado grave que asuste al niño; el significado se presenta con un espíritu alegre y de amor por el bien.

<!-- lesson-plan:end -->

<!-- lesson-plan:start audience="8-12" minutes="45" -->

### Niños de 8 a 12 años — 45 minutos

<!-- lesson-plan:outcomes -->
**Resultados de aprendizaje:** que el estudiante resuma con precisión la actitud de Umair, explique el significado de "bakh bakh" y de "at-tashmir", distinga entre postergar el bien y realizarlo de inmediato, y diseñe una tarjeta de carrera aplicable.

<!-- lesson-plan:materials -->
**Materiales:** el texto del hadiz de Muslim 1901 simplificado; tarjetas de los dos términos; plantillas de "mi carrera hacia el bien"; bolígrafos.

<!-- lesson-plan:preparation -->
**Preparación:** el profesor imprime la historia, prepara tres ejemplos de buenas obras cercanas al mundo del estudiante, y evita representar la escena del combate con detalles impactantes.

<!-- lesson-plan:opening -->
**Apertura — 5 minutos:** pregunta: «¿Alguna vez postergaste una buena obra y después te arrepentiste?». Recoge ejemplos breves de los estudiantes.

<!-- lesson-plan:evidence -->
**Estudio de la prueba — 10 minutos:** los estudiantes leen la historia e identifican la pregunta que planteó Umair, la respuesta del Profeta, la paz y las bendiciones de Allah sean con él, y la decisión que tomó inmediatamente después.

<!-- lesson-plan:instruction -->
**Instrucción guiada — 8 minutos:** el profesor explica los dos términos, y aclara explícitamente que la decisión de Umair ocurrió en un contexto de combate legítimo por orden profética, y que la lección transmitida es no postergar el bien disponible, no buscar el combate.

<!-- lesson-plan:activity -->
**Actividad — 14 minutos:** los estudiantes diseñan la tarjeta "mi carrera hacia el bien" y realizan una obra durante la clase o ese mismo día si es posible.

<!-- lesson-plan:assessment -->
**Evaluación y cierre — 8 minutos:** cada estudiante escribe dos frases: «Aprendí de Umair que...» y «La obra a la que me apresuré es...». El profesor lee el du'a al final.

<!-- lesson-plan:differentiation -->
**Atención a las diferencias:** se ofrecen inicios de frases para quienes tienen dificultades, y a los más avanzados se les encarga debatir la diferencia entre el apresuramiento y la temeridad con ejemplos de su propia vida.

<!-- lesson-plan:safeguards -->
**Precauciones docentes:** no se permite vincular la historia con la glorificación de la violencia ni animar a los niños a riesgos físicos, y no se usa la actividad para avergonzar a quien aún no ha realizado su obra; más bien se le anima con amabilidad a intentarlo después.
...
<!-- lesson-plan:preparation -->
**Preparación:** el profesor repasa el contexto de la batalla de Badr sin añadir detalles no confirmados, redacta casos generales que no señalen a ningún estudiante en particular, y prepara un marco claro que impida cualquier malentendido del "at-tashmir" como justificación del riesgo.
...
<!-- lesson-plan:assessment -->
**Evaluación y cierre — 10 minutos:** los estudiantes debaten: ¿por qué esta lección no significa que toda decisión rápida sea correcta? Luego escriben una tarjeta de salida que resuma el hadiz y una aplicación concreta.

<!-- lesson-plan:differentiation -->
**Atención a las diferencias:** al que tiene dificultades se le da un modelo parcialmente completado, y al avanzado se le encarga debatir cómo equilibra el musulmán entre el "apresuramiento" y la "reflexión detenida" en decisiones importantes no relacionadas con la adoración, como los estudios o las relaciones.

<!-- lesson-plan:safeguards -->
**Precauciones docentes:** la actividad no se usa para presionar a estudiantes que atraviesan decisiones delicadas o crisis emocionales sin el apoyo adecuado, ni se presenta la impulsividad como un valor absoluto. Si surge una angustia intensa, se detiene la discusión individual y se orienta al estudiante hacia el canal de apoyo autorizado.
